...
// autor: GNU (General Public License)
// version: 3 
public class Calculadora {
    ...
    public Calculadora(boolean gui) {  /**
         ...
         * @param gui si es verdadero se dibujará la interfaz gráfica de usuario
         */

        //Inicialización de las variables
        inicializa();

        if (gui==true) dibujaCalculadora(); // dibuja la calculadora si gui es verdadero

    }
    
 // ddibuja la interfaz gráfica de la calculadora.
    ...
    public void inicializa() { // inicializa las variables
        operacion = "null";
        valor1 = 0;
        valor2 = 0;
        modo = MODE_ENTRADA;
    ...
    public String getResultadoString (){ // obtiene el resultado como una cadena de texto
        return texto_resultado.getText(); // devuelve el resultado como una cadena de texto
    }

    public void setResultadoString(String s){ // establece el resultado como cadena de texto
        texto_resultado.setText(s); // @param s el resultado como una cadena de texto
    }

    public int getResultadoInt() { // obtiene el resultado como un entero 
        String resultado = texto_resultado.getText();
        return Integer.parseInt(resultado); // devuelve como entero 
    }

    public void anadeNuevoDigito(int digito){ // añade un nuevo digito al resultado
        if (inicializa_resultado)
            setResultadoString(""); // @param digito, el dígito a añadir
    ...
    public void ejecutarOperador(String new_operacion) { // ejecuta una nueva operación (@param new_operation)
    ...
    public void ejecutarIgual(){ // ejecuta la operación de igual
        int resultado = 0;
    ...
    public int ejecutarOperacion() { // ejecuta la operación 
        int resultado = 0;
    ...
    public void muestraResultado(int resultado){ // resultado de la operación
    ...
    public static void main(String args[]) { //método principal, crea una instancia de la calculadora y la interfaz
